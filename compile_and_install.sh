...
# This script will attempt to build and install Explicator in a distribution-aware way. 
#
...
#BUILDROOT="/home/hal/Builds/Explicator/"
BUILDROOT="/tmp/explicator_build"
#BUILDROOT="build"
